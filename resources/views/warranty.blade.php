        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group relative h-[450px] overflow-hidden cursor-pointer border border-white/5 rounded-sm">
                    <img src="https://images.unsplash.com/photo-1599619351208-3e6c839d6828?q=80&w=1000&auto=format&fit=crop" 
                ...
                <div class="group relative h-[450px] overflow-hidden cursor-pointer border border-white/5 rounded-sm">
                    <img src="https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?q=80&w=1000&auto=format&fit=crop" 
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row-reverse items-center gap-12">
                <div class="w-full md:w-1/2 relative group">
                    ...
                    <img src="https://images.unsplash.com/photo-1581094794329-cd132c097542?q=80&w=1000&auto=format&fit=crop" 
                         alt="Installation" 
                         class="relative rounded-lg shadow-2xl w-full h-[400px] object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500">
                </div>
                <div class="w-full md:w-1/2 text-right">
